                    ...
                    SingleChildScrollView(
                      ...
                      child: Row(
                        children: [
                          ...
                          const SizedBox(width: 12),
                          _buildQuickAction(Icons.view_kanban_rounded, 'Triage\nIGD', Colors.redAccent, () => Get.toNamed(Routes.triageBoard)),
                          const SizedBox(width: 12),
                          _buildQuickAction(Icons.mood_bad_rounded, 'Skala\nNyeri', Colors.orange, () => Get.toNamed(Routes.painScale)),
                          const SizedBox(width: 12),
                          _buildQuickAction(Icons.medication_liquid_rounded, 'Kepatuhan\nObat', Colors.teal, () => Get.toNamed(Routes.medicationAdherence)),
                        ],
                      ),
                    ),
                    const SizedBox(height: 16),
