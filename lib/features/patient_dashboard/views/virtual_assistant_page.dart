    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          Column(
            children: [
              // Extra space for floating header
                        ...
                        children: [
                          Stack(
                            ...
                            children: [
                              const CircleAvatar(
                                radius: 18,
                                backgroundColor: AppColors.primarySurface,
                                child: Icon(Icons.support_agent_rounded, size: 20, color: AppColors.primary),
                              ),
                              Container(
                                width: 10,
                                height: 10,
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text('KlinikTap Assistant', style: AppTextStyles.body.copyWith(fontWeight: FontWeight.bold)),
                                Text('Selalu Aktif', style: AppTextStyles.caption.copyWith(color: AppColors.success, fontSize: 10)),
                              ],
                            ),
                          ),
                        ],
